...
const GAME_OPER_TYPE GAME_OPER_TYPE_MAX = GAME_OPER_TYPE_ONLINE;
...
class GameCalculate : public ::google::protobuf::Message {
 public:
  ...
  // optional .Adoter.Asset.FAN_TYPE max_fan_type = 6;
  inline bool has_max_fan_type() const;
  inline void clear_max_fan_type();
  static const int kMaxFanTypeFieldNumber = 6;
  inline ::Adoter::Asset::FAN_TYPE max_fan_type() const;
  inline void set_max_fan_type(::Adoter::Asset::FAN_TYPE value);
...
inline ::Adoter::Asset::FAN_TYPE GameCalculate::max_fan_type() const {
  // @@protoc_insertion_point(field_get:Adoter.Asset.GameCalculate.max_fan_type)
  return static_cast< ::Adoter::Asset::FAN_TYPE >(max_fan_type_);
}
inline void GameCalculate::set_max_fan_type(::Adoter::Asset::FAN_TYPE value) {
  assert(::Adoter::Asset::FAN_TYPE_IsValid(value));
